...
A MicroPython board support module for BEAPER Nano. BEAPER_Nano.py is used by all of the beginner activities and most BEAPER Nano exampmle program. See [BEAPER_Nano_README.md](./BEAPER_Nano_REEADME.md) for details.
