...
#   H8 - Servo channel 4 (use beaper.set_servo(SERVO4, angle))
#
# BEFORE RUNNING THIS PROJECT: SERVO1 and SERVO2 are commented out by
# default in BEAPER_Nano.py, since servo pins share GPIO with headers
# H1-H4 and the I2C/QWIIC connector. Open BEAPER_Nano.py and uncomment
# these two lines (leave SERVO3/SERVO4 commented out unless you are
# also using them):
#
#   SERVO1 = PWM(Pin(H5_PIN), freq=50, duty_u16=4915)
#   SERVO2 = PWM(Pin(H6_PIN), freq=50, duty_u16=4915)
#
# Running this project without uncommenting these lines will raise
# an AttributeError, since 'beaper.SERVO1' will not exist yet. Also
# disable any I2C or SONAR code you may have added in earlier
# activities, since H5 and H6 share pins with those devices.
#
# Controls:
...
# --------------------------------------------------------------------------------
#
# Open BEAPER_Nano.py and read the 'set_servo()' function and
...
# BEAPER_Nano.py for constants that set the servo pulse width
