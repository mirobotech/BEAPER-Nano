# BEAPER Nano Beginner Activities

Beginner programming activities designed to introduce novices to microcontroller
programming using Arduino C/C++ code in the Arduino Nano ESP32 and BEAPER Nano
circuit, with the aim of providing learners with the requisite knowledge to create
their own, fully-featured simple projects such as a Simon-style memory game, a
reaction timer game, a room alarm, a servo driver, an autonomous line-following
robot, or a simple classroom Sumo robot.
...
school level computer technology class and can also be an introductory self-study
course for use with BEAPER Nano.
