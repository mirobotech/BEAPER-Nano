...
// ADC can be set to 10-bit (0-1023) via analogReadResolution(10) in setup().
...
inline int light_level() { return 4095 - analogRead(Q4); }    // Brighter -> higher values (JP1 - Enviro.)
...
inline int Q1_level()    { return 4095 - analogRead(Q1); }    // Higher reflectivity -> higher values (JP1 - Robot)
inline int Q2_level()    { return 4095 - analogRead(Q2); }    // Higher reflectivity -> higher values (JP2 - Robot)
inline int Q3_level()    { return 4095 - analogRead(Q3); }    // Higher reflectivity -> higher values (JP3 - Robot)
